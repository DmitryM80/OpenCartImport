...
class ModelCatalogTexdesigndcImport extends Model {
    ...
    public function store_db($csv)
    {
        ...
        foreach ($csv as $item) {
            ...
            foreach ($requiredOcFilterOptionFields as $productFilterField) {
                ...
                $currentFilter = ($currentFilter === 'Размер пододеяльника') ? 'Размер' : $currentFilter;
            ...
            foreach ($requiredOcProductAttributeFields as $productAttributeField) {
                ...
                $currentAttribute = ($currentAttribute === 'Размер пододеяльника') ? 'Размер' : $currentAttribute;
