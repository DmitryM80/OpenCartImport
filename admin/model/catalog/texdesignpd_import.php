...
class ModelCatalogTexdesignpdImport extends Model {
    ...
    public function store_db($csv)
    {
        ...
        foreach ($csv as $item) {
            ...
            foreach ($requiredOcFilterOptionFields as $productFilterField) {
                ...
                $currentFilter = ($currentFilter === 'Размер наволочек') ? 'Размер наволочки' : $currentFilter;
            ...
            foreach ($requiredOcProductAttributeFields as $productAttributeField) {
                ...
                $currentAttribute = ($currentAttribute === 'Размер наволочек') ? 'Размер наволочки' : $currentAttribute;
