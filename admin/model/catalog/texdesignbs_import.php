...
class ModelCatalogTexdesignbsImport extends Model {
    ...
    public function store_db($csv)
    {
        ...
        $requiredFields = [
            ...
            'Особенности',
            'Наволочки в комплекте',
            'Размер наволочек (подушек)',
            'Свойства покрывал',
        ...
        foreach ($csv as $item) {
            ...
            foreach ($requiredOcProductAttributeFields as $productAttributeField) {
                ...
                $currentAttribute = ($currentAttribute === 'Размер наволочек (подушек)') ? 'Размер наволочки' : $currentAttribute;
